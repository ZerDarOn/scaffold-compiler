...
- Tests：生成器 121 tests passed、115 subtests passed；四组合均通过 Python 3.14 冻结安装、Ruff、mypy 和项目测试；M-01 Uvicorn health、M-03 隔离 PostgreSQL/Alembic/SQL/HTTP readiness、M-04 Compose config 通过；W 中冻结 journal 驱动的真实 zipapp 外部监督式回收通过。
